...
// AdvancedProjectOptionsBuilder provides sophisticated Gitea repository creation options.
...
// NewAdvancedProjectOptionsBuilder creates a new advanced Gitea project options builder.
func NewAdvancedProjectOptionsBuilder(client *gitea.Client, logger ports.Logger) *AdvancedProjectOptionsBuilder {
...
func (b *AdvancedProjectOptionsBuilder) WithVisibility(visibility string) {
	b.opts.Private = visibility == "private"
}

// WithInitialization configures repository initialization options.
func (b *AdvancedProjectOptionsBuilder) WithInitialization(autoInit bool, readme, gitignore, license string) {
...
func (b *AdvancedProjectOptionsBuilder) WithTemplate(isTemplate bool) {
	b.opts.Template = isTemplate
}

// WithIssueLabels configures issue labels.
func (b *AdvancedProjectOptionsBuilder) WithIssueLabels(issueLabels string) {
	if issueLabels != "" {
...
func (b *AdvancedProjectOptionsBuilder) WithTrustModel(trustModel string) {
	if trustModel != "" {
...
func (b *AdvancedProjectOptionsBuilder) Build() *gitea.CreateRepoOption {
	return b.opts
}
...
func (b *AdvancedProjectOptionsBuilder) ApplyDisabledSettings(ctx context.Context, owner, projectName string) error {
...
func (b *AdvancedProjectOptionsBuilder) ApplyEnabledSettings(ctx context.Context, owner, projectName string) error {
...
func (b *AdvancedProjectOptionsBuilder) ConfigureCollaborationFeatures(ctx context.Context, owner, projectName string, config CollaborationConfig) error {
	editOpts := gitea.EditRepoOption{
...
func (b *AdvancedProjectOptionsBuilder) ConfigureCIFeatures(ctx context.Context, owner, projectName string, config CIConfig) error {
	editOpts := gitea.EditRepoOption{
...
func (b *AdvancedProjectOptionsBuilder) ConfigureRepositorySettings(ctx context.Context, owner, projectName string, config RepositoryConfig) error {
	editOpts := gitea.EditRepoOption{}
