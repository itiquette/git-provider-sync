...
func TestMergeConfigs_MultipleEnvironments(t *testing.T) {
	...
	base := &dto.AppConfiguration{
		GitProviderSyncConfs: map[string]dto.Environment{
			"dev": {
				"source1": dto.SyncConfig{
					BaseConfig: dto.BaseConfig{Domain: "dev.github.com"},
				},
			},
			"prod": {
				"source1": dto.SyncConfig{
					BaseConfig: dto.BaseConfig{Domain: "prod.github.com"},
				},
			},
		},
	}
	...
	override := &dto.AppConfiguration{
		GitProviderSyncConfs: map[string]dto.Environment{
			"prod": {
				"source1": dto.SyncConfig{
					BaseConfig: dto.BaseConfig{Domain: "prod-override.github.com"},
				},
				"source2": dto.SyncConfig{
					BaseConfig: dto.BaseConfig{Domain: "new.github.com"},
				},
			},
			"staging": {
				"source1": dto.SyncConfig{
					BaseConfig: dto.BaseConfig{Domain: "staging.github.com"},
				},
			},
		},
	}
...
func TestMergeConfigs_Mirrors(t *testing.T) {
	...
	base := &dto.AppConfiguration{
		GitProviderSyncConfs: map[string]dto.Environment{
			"prod": {
				"github": dto.SyncConfig{
					BaseConfig: dto.BaseConfig{Domain: "github.com"},
...
func TestMergeConfigs_EmptyAndNil(t *testing.T) {
	...
	sources := []configuration.ConfigSource{
		...
		{Name: "empty", Config: &dto.AppConfiguration{}, Priority: 2},
	}
	result = configuration.MergeConfigs(sources)
	assert.NotNil(t, result)
	assert.NotNil(t, result.GitProviderSyncConfs)
