...
// Package terminal provides TTY detection and terminal capabilities.
// Be functional: pure functions with no side effects.
package terminal
...
// This is the key heuristic for human vs machine output.
func IsOutput() bool {
