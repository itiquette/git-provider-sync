...
func (_m *RateLimiter) Wait(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
//   - _a0 context.Context
func (_e *RateLimiter_Expecter) Wait(_a0 interface{}) *RateLimiter_Wait_Call {
	return &RateLimiter_Wait_Call{Call: _e.mock.On("Wait", _a0)}
}

func (_c *RateLimiter_Wait_Call) Run(run func(_a0 context.Context)) *RateLimiter_Wait_Call {
