...
func (_m *GroupsServiceInterface) ListMembershipsForBillableGroupMember(gid interface{}, user int, opt *gitlab.ListMembershipsForBillableGroupMemberOptions, options ...gitlab.RequestOptionFunc) ([]*gitlab.BillableUserMembership, *gitlab.Response, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	var r1 *gitlab.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(interface{}, int, *gitlab.ListMembershipsForBillableGroupMemberOptions, ...gitlab.RequestOptionFunc) ([]*gitlab.BillableUserMembership, *gitlab.Response, error)); ok {
		return rf(gid, user, opt, options...)
	}
	if rf, ok := ret.Get(0).(func(interface{}, int, *gitlab.ListMembershipsForBillableGroupMemberOptions, ...gitlab.RequestOptionFunc) []*gitlab.BillableUserMembership); ok {
	...
	if rf, ok := ret.Get(1).(func(interface{}, int, *gitlab.ListMembershipsForBillableGroupMemberOptions, ...gitlab.RequestOptionFunc) *gitlab.Response); ok {
	...
	if rf, ok := ret.Get(2).(func(interface{}, int, *gitlab.ListMembershipsForBillableGroupMemberOptions, ...gitlab.RequestOptionFunc) error); ok {
...
func (_c *GroupsServiceInterface_ListMembershipsForBillableGroupMember_Call) Run(run func(gid interface{}, user int, opt *gitlab.ListMembershipsForBillableGroupMemberOptions, options ...gitlab.RequestOptionFunc)) *GroupsServiceInterface_ListMembershipsForBillableGroupMember_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]gitlab.RequestOptionFunc, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
		...
		run(args[0].(interface{}), args[1].(int), args[2].(*gitlab.ListMembershipsForBillableGroupMemberOptions), variadicArgs...)
	})
	return _c
}
...
func (_c *GroupsServiceInterface_ListMembershipsForBillableGroupMember_Call) RunAndReturn(run func(interface{}, int, *gitlab.ListMembershipsForBillableGroupMemberOptions, ...gitlab.RequestOptionFunc) ([]*gitlab.BillableUserMembership, *gitlab.Response, error)) *GroupsServiceInterface_ListMembershipsForBillableGroupMember_Call {
	_c.Call.Return(run)
	return _c
}
